...
class TicTacToe:
    def __init__(self, game):
        self.game = game
        self.field_image = self.get_scaled_image(path='images/field.png', res=[WIN_SIZE] * 2)
        ...
        self.line_indies_array = [[(0, 0), (0, 1), (0, 2)],
                                  [(1, 0), (1, 1), (1, 2)],
                                  [(2, 0), (2, 1), (2, 2)],
                                  [(0, 0), (1, 0), (2, 0)],
                                  [(0, 1), (1, 1), (2, 1)],
    ...
    def check_winner(self):
        for line_indices in self.line_indies_array:
    ...
    #print func/win/lost/rest
    def print_caption(self):
        pg.display.set_caption(f'Player "{"OX"[self.player]}" turn!')
        if self.winner:
            pg.display.set_caption(f'Player "{"OX"[self.player]}" WINS! Press Space to restart')
